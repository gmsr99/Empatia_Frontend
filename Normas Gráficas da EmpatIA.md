...
Suave e emocional: acolhedora e atenciosa, mas equilibrada, sem excessos.
Natural: evitar linguagem demasiado técnica, que soe artificial ou distante.
Companheira: transmitir sempre presença, apoio e empatia.
Positiva: comunicar, sempre que possível, com estruturas frásicas na afirmativa.
Exemplos de tom:
...
Código Hex: #A9C8E8
Uso Principal: Gradientes, detalhes, toques tecnológicos

Categoria: Profundidade
Nome da Cor: Azul Profundo Suave
Código Hex: #4A5E90
Uso Principal: Texto destacado, pequenos contrastes

Categoria: Neutro
Nome da Cor: Branco Puro
Código Hex: #FFFFFF
Uso Principal: Fundos, respiro, clareza

Categoria: Neutro
Nome da Cor: Cinza Suave
Código Hex: #E9EEF4
Uso Principal: Fundos alternativos, separadores

Categoria: Neutro
Nome da Cor: Cinza Profundo (texto secundário)
Código Hex: #4D4D4D
